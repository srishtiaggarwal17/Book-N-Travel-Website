        ...
        <div className="bg-black/20 h-full">
            <div className="h-full flex justify-center items-center p-4 bg-primary/10">
                <div className="container grid grid-cols-1 gap-4">
                    ...
                    {/* <form */}
                    <div data-aos="fade-up" data-aos-delay="600" className="space-y-4 bg-white p-4 rounded-md relative">
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 py-3">
                            <div>
                                ...
                                id="destination"
                                placeholder="Dubai"
                                className="w-full bg-gray-100 my-2 range accent-primary focus:outline-primary focus:outline 
                            ...
                            <div>
                                ...
                                id="destination"
                                placeholder="Dubai"
                                className="w-full !placeholder-slate-400 bg-gray-100 my-2 rounded-full
                                focus:outline-primary focus:outline outline-1 p-2">
                                </input>
                            </div>
                            <div>
